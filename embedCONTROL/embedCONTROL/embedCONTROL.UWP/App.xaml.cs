...
namespace embedCONTROL.UWP
{
    ...
    {
        public static DeploymentType AppDeploymentType = DeploymentType.Beta;
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            var logger = new LoggerConfiguration()
                ...
                .WriteTo.File(storageFolder.Path + "\\embed.log",
                    fileSizeLimitBytes: 2048 * 1024, rollOnFileSizeLimit: true,  // 2mb
            ...
            var appVer = new LibraryVersion(version.Major, version.Minor, version.Build);
            var appCtx = new ApplicationContext(new XamarinFormsMarshaller(), appVer, AppDeploymentType);
